...
extension PatreonAPI
{
    private func saveAuthCookies() async
    {
        ...
        {
            Logger.main.debug("Saving Patreon cookie \(cookie.name, privacy: .public): \(cookie.value, privacy: .public) (Expires: \(cookie.expiresDate?.description ?? "nil", privacy: .public))")
...
extension PatreonAPI: WKURLSchemeHandler
{
    public func webView(_ webView: WKWebView, start urlSchemeTask: WKURLSchemeTask)
    {
        ...
        Logger.main.debug("WKWebView intercepted handling url scheme!")
